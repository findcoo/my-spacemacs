...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(gradle-mode groovy-mode)
...
you should place your code here."
  ...
  (setq eclim-eclipse-dirs '("~/eclipse/jee-oxygen/eclipse")
        eclim-excutable "~/eclipse/jee-oxygen/eclipse/eclimd")
